        ...
        <>
			...
			<div className="mb-sm-5 mb-3 d-flex flex-wrap align-items-center text-head">
				...
				<Link to={"#"} className="btn bg-white btn-rounded me-2 mb-2 text-black shadow-sm">
					<i className="fas fa-calendar-alt me-3 scale3 text-primary"></i>Filter<i className="fas fa-chevron-down ms-3 text-primary"></i>
				</Link>
                        ...
                        <div  className="card project-boxed">
                            ...
                            <div className="card-header align-items-start">
                                <div>
                                    ...
                                    <div className="text-dark fs-14 text-nowrap"><i className="fas fa-calendar-alt me-3" aria-hidden="true"></i>Created on Sep 8th, 2020</div>
                                </div>
                                <Dropdown className="">
